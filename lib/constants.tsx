...
export const IN_GAME_ITEMS = [
    ...
    { id: 'i2', name: '火眼金睛', type: 'combat', desc: '破除 3 格內的迷霧，識破偽裝寶箱怪的真面目。', icon: '👁️', price: 80 },
...
export const TERRAIN_TYPES: Record<string, any> = {
    ...
    roots: { id: 'roots', name: '世界樹根', url: '/assets/terrains/The Sanctuary/Roots.png', scale: 1.15, vOffset: 0.0, color: '#064e3b', effect: '【阻擋】無法通行。中心裝飾與障礙。', impassable: true },
    spring: { id: 'spring', name: '能量湧泉', url: '/assets/terrains/The Sanctuary/Spring of Energy.png', scale: 1.15, vOffset: 0.0, color: '#0d3320', effect: '【特殊】回復 10% HP，擲骰 +1。' },
    ...
    portal_return_pride:    { id: 'portal_return_pride',    name: '回歸傳送門（傲慢冰川）', url: '/assets/terrains/The Sanctuary/Portal Return Pride.png',    scale: 1.15, vOffset: 0.0, color: '#a855f7', effect: '【特殊】完成 3 個定課，消耗 1 骰子傳送回本心草原。' },
    portal_return_doubt:    { id: 'portal_return_doubt',    name: '回歸傳送門（迷途森林）', url: '/assets/terrains/The Sanctuary/Portal Return Doubt.png',    scale: 1.15, vOffset: 0.0, color: '#a855f7', effect: '【特殊】完成 3 個定課，消耗 1 骰子傳送回本心草原。' },
    portal_return_anger:    { id: 'portal_return_anger',    name: '回歸傳送門（焦熱荒原）', url: '/assets/terrains/The Sanctuary/Portal Return Anger.png',    scale: 1.15, vOffset: 0.0, color: '#a855f7', effect: '【特殊】完成 3 個定課，消耗 1 骰子傳送回本心草原。' },
    portal_return_greed:    { id: 'portal_return_greed',    name: '回歸傳送門（慾望泥沼）', url: '/assets/terrains/The Sanctuary/Portal Return Greed.png',    scale: 1.15, vOffset: 0.0, color: '#a855f7', effect: '【特殊】完成 3 個定課，消耗 1 骰子傳送回本心草原。' },
    portal_return_delusion: { id: 'portal_return_delusion', name: '回歸傳送門（虛妄流沙）', url: '/assets/terrains/The Sanctuary/Portal Return Delusion.png', scale: 1.15, vOffset: 0.0, color: '#a855f7', effect: '【特殊】完成 3 個定課，消耗 1 骰子傳送回本心草原。' },
    portal_return_chaos:    { id: 'portal_return_chaos',    name: '回歸傳送門（混沌迷霧）', url: '/assets/terrains/The Sanctuary/Portal Return Chaos.png',    scale: 1.15, vOffset: 0.0, color: '#a855f7', effect: '【特殊】完成 3 個定課，消耗 1 骰子傳送回本心草原。' },
    snow_path: { id: 'snow_path', name: '積雪冰原', url: '/assets/terrains/Arrogance Peak/Snowy Path.png', scale: 1.15, vOffset: 0.0, color: '#e2e8f0', effect: '【移動】消耗 1 AP，覆薄雪的平地，可正常行走。' },
    ice_wall: { id: 'ice_wall', name: '巨大冰柱', url: '/assets/terrains/Arrogance Peak/Ice Wall.png', scale: 1.15, vOffset: 0.0, color: '#94a3b8', effect: '【阻擋】無法通行；作為平滑鏡冰滑行時的煞車緩衝物。', impassable: true },
    thin_air: { id: 'thin_air', name: '刺骨孤寒', url: '/assets/terrains/Arrogance Peak/Thin Air.png', scale: 1.15, vOffset: 0.0, color: '#cbd5e1', effect: '【減益】回合結束時，固定扣除 1 顆能量骰子。謙卑 Buff 可免疫。' },
    slippery_slope: { id: 'slippery_slope', name: '平滑鏡冰', url: '/assets/terrains/Arrogance Peak/Slippery Slope.png', scale: 1.15, vOffset: 0.0, color: '#bae6fd', effect: '【機制】踏入後失去控制，強制朝原移動方向滑動直到撞上阻擋格或邊界。謙卑 Buff 可免疫。' },
    cliffs_pride: { id: 'cliffs_pride', name: '絕雲冰壁', url: '/assets/terrains/Arrogance Peak/Cloud-Piercing Cliffs.png', scale: 1.15, vOffset: 0.0, color: '#64748b', effect: '【地障】地圖極北邊界，不可跨越。', impassable: true },
    ...
    ancient_tree: { id: 'ancient_tree', name: '千年古樹', url: '/assets/terrains/Forest of Doubt/Ancient Tree.png', scale: 1.15, vOffset: 0.0, color: '#0c120c', effect: '【阻擋】無法通行且阻擋視線。', impassable: true },
    ...
    wall_thorns: { id: 'wall_thorns', name: '嘆息荊棘牆', url: '/assets/terrains/Forest of Doubt/Wall of Thorns.png', scale: 1.15, vOffset: 0.0, color: '#0c120c', effect: '【地障】密不可分的防禦荊棘。', impassable: true },
    ...
    obsidian: { id: 'obsidian', name: '黑曜石岩', url: '/assets/terrains/Scorched Earth/Obsidian Rock.png', scale: 1.15, vOffset: 0.0, color: '#1a0a06', effect: '【阻擋】無法通行，悟空可擊碎。', impassable: true },
    ...
    abyssal_magma: { id: 'abyssal_magma', name: '虛空火海', url: '/assets/terrains/Scorched Earth/Abyssal Magma.png', scale: 1.15, vOffset: 0.0, color: '#7a1a08', effect: '【地障】嗔恨構成的致命區。', impassable: true },
    ...
    rotten_vines: { id: 'rotten_vines', name: '腐敗巨藤', url: '/assets/terrains/Swamp of Greed/Rotten Vines.png', scale: 1.15, vOffset: 0.0, color: '#14532d', effect: '【阻擋】無法通行。', impassable: true },
    deep_bog: { id: 'deep_bog', name: '深淵泥淖', url: '/assets/terrains/Swamp of Greed/Deep Bog.png', scale: 1.15, vOffset: 0.0, color: '#022c22', effect: '【減益】踏入後強制停止移動，下回合移動力減半。完成 q6 或 q7 後免疫。' },
    mimic: { id: 'mimic', name: '偽裝寶箱', url: '/assets/terrains/Swamp of Greed/Mimic Chest.png', scale: 1.15, vOffset: 0.0, color: '#1a3520', effect: '【機制】踏入後進行慧根檢定（d20 + 慧根 vs DC 12）：失敗扣 1 骰，成功獲 1 骰。每次踏入皆觸發。' },
    corrupted_vines: { id: 'corrupted_vines', name: '腐化巨藤', url: '/assets/terrains/Swamp of Greed/Corrupted Vines.png', scale: 1.15, vOffset: 0.0, color: '#064e3b', effect: '【地障】致命的劇毒藤蔓。', impassable: true },
    ...
    sandstorm_wall: { id: 'sandstorm_wall', name: '沙塵暴壁', url: '/assets/terrains/delusion/Sandstorm Wall.png', scale: 1.15, vOffset: 0.0, color: '#451a03', effect: '【阻擋】暫時無法通行的動態牆。', impassable: true },
    ...
    chaos_storm_barr: { id: 'chaos_storm_barr', name: '混沌風暴', url: '/assets/terrains/delusion/Chaos Sandstorm.png', scale: 1.15, vOffset: 0.0, color: '#2d1a08', effect: '【地障】視覺與行進終極障礙。', impassable: true },
    ...
    glitch_wall: { id: 'glitch_wall', name: '錯誤代碼牆', url: '/assets/terrains/The Chaos/Glitch Wall.png', scale: 1.15, vOffset: 0.0, color: '#1e293b', effect: '【阻擋】業障牆。無法通行、破壞或穿越。', impassable: true },
    ...
    void: { id: 'void', name: '虛空邊界', url: '/assets/terrains/The Chaos/Event Horizon.png', scale: 1.15, vOffset: 0.0, color: '#020617', effect: '【地障】墜入虛空！扣 50% HP 並傳回中心。', impassable: true },
};

export const zoneWeights: Record<string, string[]> = {
    center: ['grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'roots', 'spring', 'roots_yggdrasil', 'portal'],
    pride:    ['snow_path', 'snow_path', 'snow_path', 'snow_path', 'snow_path', 'snow_path', 'snow_path', 'snow_path', 'snow_path', 'snow_path', 'snow_path', 'snow_path', 'ice_wall', 'thin_air', 'slippery_slope', 'cliffs_pride', 'portal_return_pride'],
    doubt:    ['dark_trail', 'dark_trail', 'dark_trail', 'dark_trail', 'dark_trail', 'dark_trail', 'dark_trail', 'dark_trail', 'dark_trail', 'dark_trail', 'dark_trail', 'dark_trail', 'ancient_tree', 'fog', 'thorns', 'wall_thorns', 'portal_return_doubt'],
    anger:    ['cracked_earth', 'cracked_earth', 'cracked_earth', 'cracked_earth', 'cracked_earth', 'cracked_earth', 'cracked_earth', 'cracked_earth', 'cracked_earth', 'cracked_earth', 'cracked_earth', 'cracked_earth', 'obsidian', 'lava', 'geyser', 'abyssal_magma', 'portal_return_anger'],
    greed:    ['wetland', 'wetland', 'wetland', 'wetland', 'wetland', 'wetland', 'wetland', 'wetland', 'wetland', 'wetland', 'wetland', 'wetland', 'rotten_vines', 'deep_bog', 'mimic', 'corrupted_vines', 'portal_return_greed'],
    delusion: ['sand_dune', 'sand_dune', 'sand_dune', 'sand_dune', 'sand_dune', 'sand_dune', 'sand_dune', 'sand_dune', 'sand_dune', 'sand_dune', 'sand_dune', 'sand_dune', 'sandstorm_wall', 'quicksand', 'mirage', 'chaos_storm_barr', 'portal_return_delusion'],
    chaos:    ['ash_path', 'ash_path', 'ash_path', 'ash_path', 'ash_path', 'ash_path', 'ash_path', 'ash_path', 'ash_path', 'ash_path', 'ash_path', 'ash_path', 'glitch_wall', 'entropy_field', 'random_anomaly', 'void', 'portal_return_chaos']
};
...
/**
 * 根據地圖幾何動態計算各區子區 0 的世界座標入口點。
 * 與 WorldMap.tsx / app/map/page.tsx 的 sideData 邏輯保持一致。
 */
